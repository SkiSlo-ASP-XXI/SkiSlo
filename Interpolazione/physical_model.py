...
def esegui_simulazione(x_traj, y_traj, z_traj, ts_com, m=80, g=9.81, mu=0.16, rho=1.225, CdA=0.3, v0=4.91):
    """
    ...
    # ==========================================
    dt = np.diff(ts_com)
    # Se i tempi presentano duplicati o zeri, per sicurezza mettiamo un dt piccolissimo
    dt[dt == 0] = 1e-5 
